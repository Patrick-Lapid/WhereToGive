import { Card, Image, Group, Text, Button, Badge, Paper, Avatar } from '@mantine/core';
...
const data = [
    ...
    },
    {
        ...
        "DescriptionLong": "A Family for Every Orphan is a Christian organization that helps orphans find loving families in their home countries. Our vision is a world without orphans!",
        "Location": "SEATTLE, WA",
    ...
    return (
        <div className='d-flex' style={{width : "95%",margin: '1rem auto 0'}}>
            {data.map((charity, index) => {
                ...
                >
                <Avatar src={`${charity.LogoURL}`} size={50} radius={50} mx="auto" />
